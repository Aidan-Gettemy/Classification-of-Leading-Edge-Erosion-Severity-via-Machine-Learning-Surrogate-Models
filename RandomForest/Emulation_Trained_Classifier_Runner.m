...
% Load the dataset
% For Experiment 1: Section 4.4
data_zgp = readtable("LARGE2ExperimentResultTable1_zGP.txt");
zGP_params = load("zGP_params.mat");
IN_TRAIN = data_zgp;
OUT_TRAIN = data_zgp;

% For Experiment 2: Section 4.4.1
% data_zgp   = readtable("LARGE2noisyExperimentResultTable210_zGP.txt");
% zGP_params   = load("zGP_params210noisy.mat");
% IN_TRAIN = data_zgp;
% OUT_TRAIN = data_zgp;

% Load the variable names for either experiment 1 or 2
...
% For Experiment 3: Section 4.4.2
% emulator_data_original = readtable("../Data/Exp7/LARGE3ExperimentResultTable1_470.txt");
...
%% Define the ensemble classifier (Random Forest)
...
% True Testing Data
testingDataID = "../Data/Exp6/LARGE3ExperimentResultTable1_600.txt";
...
%% Step 6.) Save
save("TEST1star_results_em5000_repeatedCV.mat","results_em","-v7.3")
