...
saveTabID = ExperimentID+"/LARGE2noisyExperimentResultTable1_500.txt";
writetable(expTab,saveTabID);
%%
T1 =      readtable("Data\Exp10\LARGE2ExperimentResultTable1_500.txt");
T2 = readtable("Data\Exp10\LARGE2noisyExperimentResultTable1_500.txt");
%%
figure

hold on
scatter(T1,"B1Er1","B1N6Clmean")
...
saveTabID = ExperimentID+"/LARGE3ExperimentResultTable1_500.txt";
writetable(expTab,saveTabID);